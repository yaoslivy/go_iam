...
import (
	...
	"go_iam/pkg/log"
	"go_iam/pkg/shutdown"
	"go_iam/pkg/shutdown/shutdownmanagers/posixsignal"
	"go_iam/pkg/storage"

	cachev1 "go_iam/internal/apiserver/controller/v1/cache"
	genericoptions "go_iam/internal/pkg/options"
...
func createAPIServer(cfg *config.Config) (*apiServer, error) {
	...
	// complete configuration and new http service instance.
	// initGenericAPIServer(InstallMiddlewares, InstallAPIs)
	genericServer, err := genericConfig.Complete().New()
	if err != nil {
		return nil, err
	}
	// complete configuration and new rpc service instance.
	// TLS, grpc, mysql
