...
import (
	"flag"
	"go_iam/internal/iamctl/cmd/color"
	"go_iam/internal/iamctl/cmd/completion"
	"go_iam/internal/iamctl/cmd/info"
	"go_iam/internal/iamctl/cmd/jwt"
	"go_iam/internal/iamctl/cmd/new"
	"go_iam/internal/iamctl/cmd/options"
	"go_iam/internal/iamctl/cmd/policy"
	"go_iam/internal/iamctl/cmd/secret"
	"go_iam/internal/iamctl/cmd/set"
	"go_iam/internal/iamctl/cmd/user"
	"go_iam/internal/iamctl/cmd/validate"
	"go_iam/internal/iamctl/cmd/version"
	"go_iam/internal/iamctl/util/templates"
	"go_iam/pkg/cli/genericclioptions"
	"io"
	"os"
	...
	cmdutil "go_iam/internal/iamctl/cmd/util"
